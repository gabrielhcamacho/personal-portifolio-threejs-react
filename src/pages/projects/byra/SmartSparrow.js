...
const title = 'Designing the future of tech community';
const description =
  "I'm creating a new way for developers to interact, learn, share and stay tunned. A new hub community ";
const roles = [
  'UX and UI Design',
    ...
    <Fragment>
      <ProjectContainer className="spr">
        ...
        <ProjectBackground
          ...
          src={bgtop}
          srcSet={`${bgtop.src} 1080w, ${bgtop.src} 2160w`}
          placeholder={bgtop}
        />
        <ProjectHeader
          title={title}
        ...
        <ProjectSection light={isDark}>
          <ProjectSectionContent>
            ...
            {/* <ProjectTextRow>
              <ProjectSectionHeading>Tech used</ProjectSectionHeading>
              <ProjectSectionText>
        ...
        <ThemeProvider themeId="dark" data-invert>
          <ProjectSection
            ...
            backgroundElement={
              <Image
                srcSet={[backgroundTech, backgroundTech]}
                placeholder={backgroundTech}
            ...
            <ProjectSectionColumns width="full">
              <ProjectSectionContent width="full">
                <ProjectTextRow width="s">
                  <ProjectSectionHeading>Tech used</ProjectSectionHeading>
                  <ProjectSectionText>
                  This project is created using React with Next.js, TailwindCSS, NextAuth.js for social login, Node.js, PostgreSQL, and MongoDB, as well as using third party Rest APIs. It leverages the latest web technologies to deliver a seamless user experience.
                  </ProjectSectionText>
                </ProjectTextRow>
              </ProjectSectionContent>
              <Image
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow>
              <ProjectSectionHeading>Fostering Information</ProjectSectionHeading>
              <ProjectSectionText>
                With Byra, not only everyone can connect and get questions answered, but also filter news in the tech world based in yours preferences
              </ProjectSectionText>
            </ProjectTextRow>
            <Image
              raised
              ...
              <ProjectSection>
                <ProjectSectionContent>
                  <ProjectTextRow center>
                    ...
                    <ProjectSectionText>
                      The flexibility of the platform allow for developers to create
                      engaging interactive experiences that
                      could then be used to foster the learning from others.
                    </ProjectSectionText>
                  </ProjectTextRow>
                </ProjectSectionContent>
              </ProjectSection>
              ...
              <ProjectSection>
                <ProjectSectionContent width="xl">
                  <ProjectTextRow justify="end" width="s">
                    ...
                    <ProjectSectionText>
                      With this project, you able able to connect 
                      with any developer around the world as easy as in a pub. Our main goal was to keep easy and simple to connect and engage
                    </ProjectSectionText>
                  </ProjectTextRow>
                </ProjectSectionContent>
              </ProjectSection>
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow center centerMobile noMargin>
              <ProjectSectionHeading>Our Hopes</ProjectSectionHeading>
              <ProjectSectionText>
                Ultimately the project is still in development. We hope to conclude it and be of value for developers around the globe, mainly the ones tying to start their carrers
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
